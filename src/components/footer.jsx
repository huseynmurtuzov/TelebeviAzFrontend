          ...
          <div className="footer-content">
            <div className="footer-brand">
              <div className="brand-logo">
                <img src="/telebevi-logo-house.png" alt="Telebevi Logo" className="logo-image" />
                <span className="brand-name">telebevi.az</span>
              </div>
              <p className="brand-description">
                Azərbaycanın ən böyük tələbə mənzil axtarış platforması. Təhlükəsiz, rahat və münasib qiymətə yaşayış
                yerləri.
              </p>
        ...
        <div className="container">
          <div className="footer-bottom-content">
            <div className="copyright">
              <p>&copy; 2024 Telebevi. Bütün hüquqlar qorunur.</p>
            </div>
